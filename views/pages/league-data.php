           ...
           <div class="uk-width-expand@l">
            <!-- Start Content -->
                <?php
                    ...
                    // Tier 1 - Score/Teams
                    $team_request = wp_remote_get( 'https://fly.sportsdata.io/v3/'.strtolower($leagueName).'/scores/json/teams', $header_dak );
                    ...
                    <?php foreach ( array_slice($news_body, 0, 9) as $news ) : 
                        ...
                        foreach ( $team_body as $team ) {
                            ...
                            if ( $team->TeamID != $news->TeamID )
                                ...
                                $teamName  = $team->Name;
                                $teamCity  = $team->City;
                                $teamFName = ($leagueName === 'NFL') ? $team->FullName : $team->Name;
