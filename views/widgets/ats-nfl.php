...
// Dev API Unlimited
$season_request = wp_remote_get( 'https://fly.sportsdata.io/v3/nfl/scores/json/CurrentSeason', $nfl_header_dak );
$season_body    = json_decode( wp_remote_retrieve_body( $season_request ) );

$standing_request = wp_remote_get( 'https://fly.sportsdata.io/v3/nfl/scores/json/Standings/'.$season_body->Season.'',  $nfl_header_dak );
$standing_body    = json_decode( wp_remote_retrieve_body( $standing_request ) );

$team_request = wp_remote_get( 'https://fly.sportsdata.io/v3/nfl/scores/json/teams', $nfl_header_dak );
        ...
        <table class="uk-table uk-table-divider">
            <thead>
                <tr>
                    ...
                    <th>Home</th>
                    <th>Away</th>
                    <th><small hidden>Last 5 Games</small> ATS Home</th>
                    <th><small hidden>Last 5 Games</small> ATS Away</th>
                    <th><small hidden>Last 5 Games</small> OV/UN Home</th>
                    <th><small hidden>Last 5 Games</small> OV/UN Away</th>
                </tr>
            </thead>
            <tbody>
            <?php if ( $team_body ) :
