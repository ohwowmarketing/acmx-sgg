    ...
    <div class="uk-flex uk-flex-between _headings">
        ...
        <div class="button-select-wrapper">
            ...
            <div uk-dropdown="mode: click">
                ...
                <?php 
                foreach ( $betting_states as $state ) : ?>
                    <?php /*<li><a href="<?php echo esc_url(site_url('best-books').'?state_abbr='.$state['value']); ?>"><?php echo $state['label'] ?></a></li> */ ?>
                    <li><a href="<?php echo esc_url( site_url('checking-location.php?key='.$post->ID.'&state_abbr='.$state['value']) ); ?>" target="_self" rel="noopener"><?php echo $state['label'] ?></a></li>
                <?php 
                endforeach; ?>
                </ul>
            </div>
