...
$sportsbooks = [ 
    [ 
        ...
        'state' => [
            ...
            'NJ' => 'https://wlsugarhouseaffiliates.adsrv.eacdn.com/C.ashx?btag=a_4354b_195c_&affid=1248&siteid=4354&adid=195&c='
        ]
    ], 
    [ 
        'id' => 'UnibetNJ',
...
<div uk-grid class="uk-flex-between uk-flex-middle uk-margin-bottom odds-locations">
    <?php do_action( 'odds_nav', 'mlb' ); ?>
    <?php do_action( 'odds_location', 'mlb' ); ?>
</div>        
