                ...
                <div id="guide-content" class="uk-card uk-card-default uk-card-body" data-card="guides">
                    ...
                    <?php
                        ...
                        if ( $videoHDR ) {
                            ...
                            echo '<iframe src="https://www.youtube.com/embed/'.$my_array_of_vars["v"].'?autoplay=1&amp;showinfo=0&amp;rel=0&amp;modestbranding=1&amp;playsinline=1" frameborder="0" allowfullscreen uk-responsive uk-video="automute: true"></iframe>';
                            echo '</div>';
