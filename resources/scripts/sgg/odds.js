        ...
        if (json_data.length) {
          ...
          if (data.state) {
            ...
            data.sportsbooks.map((sportsbook) => {
              if (sportsbook.id === 'DraftKings') {
                $('.odds-game-bet-now').each(function () {
                  $(this).html(
                    `<a href="${sportsbook.link}" role="button" type="button" class="uk-button uk-button-default uk-button-small"><img src="${SGGAPI.directory}/resources/images/sportsbooks/dk-d-crown.png" width="75" height="75" class="dk" />&nbsp;Bet Now</a>`
                  )
                })
              }
